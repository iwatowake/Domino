...
namespace UnityEngine
{
	...
	/// HSV色空間を扱うクラス
	/// </summary>
	public static class uchiColorHSV
	{
		...
		{
			if (h > 360.0)
				throw new ArgumentOutOfRangeException ("h", h, "0～360で指定してください。");
			if (h < 0.0)
				throw new ArgumentOutOfRangeException ("h", h, "0～360で指定してください。");
			if (s > 1.0)
				throw new ArgumentOutOfRangeException ("s", s, "0.0～1.0で指定してください。");
			if (s < 0.0)
				throw new ArgumentOutOfRangeException ("s", s, "0.0～1.0で指定してください。");
			if (v > 1.0)
				throw new ArgumentOutOfRangeException ("v", v, "0.0～1.0で指定してください。");
			if (v < 0.0)
				throw new ArgumentOutOfRangeException ("v", v, "0.0～1.0で指定してください。");
	...
	public static class ColorExtension
	{
		...
		public static Color Offset (this Color c, int offsetH, int offsetS, int offsetV)
		{
			...
			return uchiColorHSV.FromHsv (newH, newS, newV);
		}
